...
namespace interval_arithmetic
{
    ...
    template <typename T>
    Interval<T> IAdd(const Interval<T> &x,
                     const Interval<T> &y);
    template <typename T>
    Interval<T> ISub(const Interval<T> &x,
                     const Interval<T> &y);
    template <typename T>
    Interval<T> IDiv(const Interval<T> &x,
                     const Interval<T> &y);
    template <typename T>
    Interval<T> IMul(const Interval<T> &x,
                     const Interval<T> &y);
    template <typename T>
    ...
    template <typename T>
    Interval<T> DIAdd(const Interval<T> &x,
                      const Interval<T> &y);
    template <typename T>
    Interval<T> DISub(const Interval<T> &x,
                      const Interval<T> &y);
    template <typename T>
    Interval<T> DIDiv(const Interval<T> &x,
                      const Interval<T> &y);
    template <typename T>
    Interval<T> DIMul(const Interval<T> &x,
                      const Interval<T> &y);
    template <typename T>
    ...
    template <typename T>
    Interval<T> Hull(const Interval<T> &x,
                     const Interval<T> &y);
    template <typename T>
    ...
    Interval<T> ISin(const Interval<T> &x)
    {
        ...
        else
        {
            ...
            do
            {
                ...
                if ((w.a != 0) && (w.b != 0))
                {
                    if ((abs(w.a - w1.a) / abs(w.a) < eps) && (abs(w.b - w1.b) / abs(w.b) < eps))
                        finished = true;
                    else
                        ;
                }
                ...
                {
                    if ((abs(w.a - w1.a) < eps) && (abs(w.b - w1.b) / abs(w.b) < eps))
                        finished = true;
                    else
                        ;
                }
                ...
                {
                    if ((abs(w.a - w1.a) / abs(w.a) < eps) & (abs(w.b - w1.b) < eps))
                        finished = true;
